...
// ─── Schema (B2B version excluding 3.2, 3.5, 3.6) ────────────────────────
...
const STEPS = [
  {
    id: 'provider', title: 'Partner Type', description: 'Select your provider / partner type.',
    fields: ['provider_type'] as (keyof FormData)[],
  },
  {
        ...
        >
          <div className="space-y-3">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">
              Your B2B registration is under review. Our team will verify your contact and location details.
            </p>
          </div>
          <div className="p-5 bg-orange-50/60 rounded-2xl border border-orange-100 flex items-start gap-4 text-left">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed mt-0.5">
                Your B2B Client ID will be generated after admin review and sent to your registered email and mobile.
              </p>
            </div>
          </div>
          <button
        ...
        <div className="space-y-12">
            ...
            {iconSrc && (
              <div className="flex items-center gap-4 animate-in fade-in slide-in-from-left-4 duration-700">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs font-bold text-slate-400">Verified Partner</span>
                </div>
              </div>
            )}
          </div>
          <div className="space-y-6">
            ...
            <p className="text-xl text-slate-500 max-w-md leading-relaxed">
              Connect your healthcare facility directly with our platform using our simplified B2B partner gateway.
            </p>
          </div>
        </div>
